...
const loaderDiv = document.getElementById('smartwatch-loader');
const hintDiv = document.getElementById('smartwatch-hint');
...
loader.load('/models/Smartwatch.glb', function (gltf) {
    model = gltf.scene;
